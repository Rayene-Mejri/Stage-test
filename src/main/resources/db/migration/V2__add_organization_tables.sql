...
INSERT INTO `employees` (`id`, `first_name`, `last_name`, `email`, `job_title`, `salary`, `hire_date`, `department_id`) VALUES
...
INSERT INTO `projects` (`id`, `name`, `description`, `status`, `start_date`, `end_date`, `department_id`) VALUES
...
INSERT INTO `equipments` (`id`, `name`, `serial_number`, `category`, `purchase_date`, `employee_id`) VALUES
